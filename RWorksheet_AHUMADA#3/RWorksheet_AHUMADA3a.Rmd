...
str(city_temp)
#The city_temp object's structure was shown by the code. 
#It presented the data frame's contents.
#It showed the data frame's executive summary.
